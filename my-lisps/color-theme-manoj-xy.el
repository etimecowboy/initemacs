;; -*- Mode: Emacs-Lisp -*-
;; color-theme-manoj-xy.el --- 
;; Author    : Xin Yang
;; Based On  : Manoj Srivastava's `color-theme-manoj.el'---
;; http://orgmode.org/worg/color-themes/color-theme-manoj.el
;; Time-stamp:<2011-09-09 Fri 13:06 xin on P6T-WIN7>
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

;;;###autoload
(defun color-theme-manoj-xy-font-lock ()
  "My face settings for basic font-lock."

  (interactive)
  (color-theme-install
   '(color-theme-manoj-xy-font-lock
     nil
     (font-lock-builtin-face       ((t (:foreground "LightSteelBlue"))))
	 (font-lock-comment-face       ((t (:italic t :slant oblique :foreground "DimGrey"))))
     (font-lock-comment-delimiter-face ((t (:foreground "Chocolate1"))))
     (font-lock-constant-face      ((t (:background "DarkSlateBlue" :foreground "Chartreuse" :bold t))))
	 (font-lock-doc-face           ((t (:italic t :slant oblique :foreground "LightSalmon"))))
	 (font-lock-doc-string-face    ((t (:foreground "Plum"))))
	 (font-lock-function-name-face ((t (:background "Wheat" :foreground "Blue" :weight bold))))
     ...
     (font-lock-type-face          ((t (:foreground "PaleGreen")))) ;PaleGreen
...
;;;###autoload
(defun color-theme-manoj-xy-dired ()
  "My face settings for dired-mode."
  
  (interactive)
  (color-theme-install
   '(color-theme-manoj-xy-dired
     nil
     ...
     (dired-flagged ((t (:foreground "white" :background "blue" :weight bold))))
     ...
     (diredp-dir-heading ((t (:background "LightGray" :foreground "Blue" :weight bold))))
...
;;;###autoload
(defun color-theme-manoj-xy-gnus ()
  "My face settings for Gnus."

  (interactive)
  (color-theme-install
   '(color-theme-manoj-xy-gnus
     nil
...
;;;###autoload
(defun color-theme-manoj-xy-message ()
  "My face settings for message-mode."
  
  (color-theme-install
   '(color-theme-manoj-xy-message
     nil
...
;; ;;;###autoload
;; (defun color-theme-manoj-xy-erc ()
;;   "My face settings for ERC."

;;   (color-theme-install
;;    '(color-theme-manoj-xy-erc
;;      nil
...
;; ;;;###autoload
;; (defun color-theme-manoj-xy-egg ()
;;   "My face settings for Egg."
...
;; 	 (egg-blame-subject ((t (:background "grey85" :foreground "black" :height 1.1))))
;; 	 (egg-branch ((t (:bold t :weight bold :foreground "SkyBlue" :height 1.2100000000000002))))
...
;; 	 (egg-diff-file-header ((t (:bold t :weight bold :foreground "SlateBlue" :height 1.1))))
...
;; 	 (egg-section-title ((t (:bold t :weight bold :foreground "DarkGoldenrod" :height 1.2100000000000002))))
...
;; 	 (egg-unmerged-diff-file-header ((t (:bold t :weight bold :foreground "Red" :height 1.1))))
;; 	 (egg-warning ((t (:bold t :weight bold :foreground "Red")))))))

;;;###autoload
(defun color-theme-manoj-xy-org ()
  "My org-mode color."
  ...
  (color-theme-install
   '(color-theme-manoj-xy-org
	 ...
	 (org-agenda-diary ((t (:foundry "unknown" :width normal :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "ivory2" :stipple nil))))
	 ...
	 (org-checkbox ((t (:bold t :weight bold :stipple nil :foreground "ivory2" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :width normal :foundry "unknown"))))
	 ...
	 (org-level-1 ((t (:bold t :width normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :stipple nil :foreground "LightSkyBlue" :weight bold :height 1.50))))
	 (org-level-2 ((t (:bold t :weight bold :stipple nil :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :width normal :foreground "orange" :height 1.25))))
	 (org-level-3 ((t (:slant normal :stipple nil :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :weight normal :width normal :foreground "green" :height 1.10))))
	 (org-level-4 ((t (:slant italic :stipple nil :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :weight normal :width normal :foreground "cyan3"))))
	 (org-level-5 ((t (:slant italic :stipple nil :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :weight normal :width normal :foreground "orchid"))))
	 (org-level-6 ((t (:width normal :weight normal :slant italic :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :stipple nil :foreground "LightGoldenrod1"))))
	 (org-level-7 ((t (:width normal :weight normal :slant italic :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :stipple nil :foreground "gold"))))
	 (org-level-8 ((t (:width normal :weight normal :slant italic :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :stipple nil :foreground "lawn green"))))
	 (org-link ((t (:foreground "Cyan" :underline t))))
	 (org-meta-line ((t (:italic t :foreground "cyan3" :foundry "unknown" :width normal :weight normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :stipple nil :slant italic))))
...
;;;###autoload
(defun color-theme-manoj-xy-dark ()
  "My dark background color-theme."
  ...
  (let ((color-theme-is-cumulative t))
    (color-theme-install
     '(color-theme-manoj-xy-dark
       ...
       ;; (Info-title-4-face ((t (:bold t :family "helv" :weight
       ;; bold))))
       ...
       (flyspell-incorrect-face ((t (:foreground "Red" :bold t :underline t))))
       ...
       (mode-line-inactive ((t (:box (:line-width 1 :color "#254394") :foreground "white" :background "grey40"))))
