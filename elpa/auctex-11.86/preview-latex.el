...
;; (add-to-list 'load-path (expand-file-name "auctex-autoloads" (file-name-directory load-file-name)))
(defvar preview-datadir (expand-file-name "auctex-autoloads" (file-name-directory load-file-name)))
