...

;;;### (autoloads (bmkp-version) "bookmark+" "bookmark+.el" (20438
;;;;;;  59403))
...
(defvar bmkp-new-bookmark-default-names (let ((fns '((lambda nil (let ((ff (function-called-at-point))) (and ff (symbolp ff) (symbol-name ff))))))) (when (fboundp 'region-or-non-nil-symbol-name-nearest-point) (push 'region-or-non-nil-symbol-name-nearest-point fns))) "\
...
;;;;;;  "bookmark+-bmu" "bookmark+-bmu.el" (20438 59403))
...
;;;;;;  "bookmark+-mac" "bookmark+-mac.el" (20438 59403))
...
;;;;;;  "bookmark+-key.el" "bookmark+-pkg.el") (20438 59403 718647))
