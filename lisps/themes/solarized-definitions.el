    ...
    (let ((base03    (find-color 'base03))
      ...
      (let ((back base03))
        ...
        `((;; basic
           ...
           (org-level-1 ((t (:foreground ,magenta :weight ,bold :height 1.30))))
           (org-level-2 ((t (:weight ,bold :foreground ,violet :height 1.20))))
           (org-level-3 ((t (:slant ,italic :foreground ,yellow :height 1.10))))
